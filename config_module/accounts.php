...
<head>
    ...
    <title><?php echo $sitename; ?> | Account(s)</title>
    <!-- Global stylesheets -->
    <style>
...
<div class="page-container">
            ...
            <div class="content">
                    ...
                    <form action="" id="user_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="panel-heading">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mobile">
                                    <div class="form-group">
                                        <label class="col-lg-5 control-label" style="color: #191e3a;">Account Name * : </label>
                                        <div class="col-lg-7">
                                ...
                                <div class="col-md-6 mobile">
                                    <div class="form-group">
                                        <label class="col-lg-5 control-label" style="color: #191e3a;">Account Type * : </label>
                                        <div class="col-lg-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mobile">
                                    <div class="form-group">
                                        <label class="col-lg-5 control-label" style="color: #191e3a;">Contact Number  </label>
                                        <div class="col-lg-7">
                                ...
                                <div class="col-md-6 mobile">
                                    <div class="form-group">
                                        <label class="col-lg-5 control-label" style="color: #191e3a;">Website : </label>
                                        <div class="col-lg-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mobile">
                                    <div class="form-group">
                                        <label class="col-lg-5 control-label" style="color: #191e3a;">Upload Logo : </label>
                                        <div class="col-lg-7">
                ...
                <form action="" id="update-form" method="post" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <button type="button" class="btn btn-primary" onclick="submitForm('delete_accounts.php')"
                        ...
                        <form action="" id="user_form" enctype="multipart/form-data" class="form-horizontal"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-lg-5 control-label" >Account Name * : </label>
                                            <div class="col-lg-7">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-lg-5 control-label">Upload New Logo : </label>
                                            <div class="col-lg-7">
								...
								<div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-lg-5 control-label">Previous Logo Preview : </label>
                                            <div class="col-lg-7">
