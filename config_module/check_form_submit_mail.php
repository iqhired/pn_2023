...
$sql = "select * from form_frequency_data where enabled != '0' and DATE_ADD(line_up_time,interval 2 hour)";
   ...
   // $arrusrs = explode(',', $rowc['users']);
    ...
    if($f_type == '4'){
        ...
        if($chicagotime >= $line_up_time) {
            ...
            $message2 = "The station starts already 2 hours and completed still not submit any forms.";
