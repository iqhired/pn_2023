...
<head>
    ...
    <title>
        <?php echo $sitename; ?> |Update Defect List</title>
    <!-- Global stylesheets -->
            ...
            <div class="breadcrumb-header justify-content-between">
                <div class="left-content">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Defect List</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                          <div class="card-header">
                            <span class="main-content-title mg-b-0 mg-b-lg-1">Edit Defect List</span>
                        </div>
                          <?php
                           ...
                           <div class="pd-30 pd-sm-20">
                            <div class="row row-xs">
                                ...
                                <div class="col-md-8 mg-t-10 mg-md-t-0">
                                    ...
                                    $rowc = mysqli_fetch_array($qur);
                                    ?>
                                    <select name="edit_part_number[]" id="edit_part_number" class="form-control form-select select2"  multiple="multiple">
                                        <?php
