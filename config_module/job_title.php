...
//edit
    ...
    if ($edit_name != "") {
        $id = $_POST['edit_id'];
        $sql = "update cam_job_title set job_name='$_POST[edit_name]',updated_at='$chicagotime' where job_title_id='$id'";
...
<html lang="en">
    <head>
        ...
        <title><?php echo $sitename; ?> | Job - Title</title>
        <!-- Global stylesheets -->
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <form action="" id="user_form" class="form-horizontal" method="post">
                                                <div class="col-md-6 mob_user">
                                                    <input type="text" name="name" id="name" class="form-control" placeholder="Enter Job Title" required>
                                                </div>
                                                <div class="col-md-4 mob_user">
                                                    <button type="submit" class="btn btn-primary" style="background-color:#1e73be;">Create Job Title</button>
                                                </div>
                                            </form>
...
while ($rowc = mysqli_fetch_array($qur)) {
    ?> 
                                            <tr>
                                                <td><input type="checkbox" id="delete_check[]" name="delete_check[]" value="<?php echo $rowc["job_title_id"]; ?>"></td>
                                                <td><?php echo ++$counter; ?></td>
                                                <td><?php echo $rowc["job_name"]; ?></td>
      <!--                                         <td>--><?php //echo $rowc['created_at']; ?><!--</td>-->
      <!--                                        <td>--><?php //echo $rowc['updated_at']; ?><!--</td>-->
                                                <td>
                                                    <button type="button" id="edit" class="btn btn-info btn-xs" data-id="<?php echo $rowc['job_title_id']; ?>" data-name="<?php echo $rowc['job_name']; ?>"  data-toggle="modal" style="background-color:#1e73be;" data-target="#edit_modal_theme_primary">Edit </button>
                                                    <!--									&nbsp; 
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    ...
                                    <h6 class="modal-title">Update Job-Title</h6>
                                </div>
                                <form action="" id="user_form" class="form-horizontal" method="post">
