...
//check the station event id submit in form submit
$sql3 = "SELECT * FROM `form_user_data` WHERE station_event_id = '$station_event_id'";
$result3 = mysqli_query($db, $sql3);
$cam3 = mysqli_fetch_array($result3);
$st_event_id = $cam3['station_event_id'];

if(!empty($st_event_id)){
$sql4 = "SELECT * FROM `form_user_data`";
$result4 = mysqli_query($db, $sql4);
$cam4 = mysqli_fetch_array($result4);
    $f_type = $cam4['form_type'];
}
?>
<!DOCTYPE html>
<html lang="en">
