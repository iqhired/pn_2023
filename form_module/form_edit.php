                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <select name="part_number" id="part_number" class="form-control form-select select2" data-bs-placeholder="Select Country">
                                        ...
                                        while ($row1 = $result1->fetch_assoc()) {
                                            ...
                                            $part_st = "select line_name from `cam_line` where line_id = '$part_st'";
                                            $result_st = $mysqli->query($part_st);
                                            $part_st = mysqli_fetch_assoc($result_st);
                                            ...
                                            echo "<option value='" . $row1['pm_part_number_id'] . "' $entry >" . $row1['part_number'] . " - " . $row1['part_name'] . " - " . $part_fam['part_family_name'] . " - " . $part_st['line_name'] ."</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                            <div class="row mg-t-15">
                                                ...
                                                <div class="col-lg-2 mg-t-20 mg-lg-t-0"><label class="rdiobox">
                                                        <input type="radio" id="header_<?php echo $rowcount; ?>"
                                                ...
                                                <div class="col-lg-2 mg-t-20 mg-lg-t-0"><label class="rdiobox">
                                                        <input type="radio"
                                                               id="text_<?php echo $rowcount; ?>" <?php if ($item_val == "text") {
                                                            echo 'checked';
                                                        } ?> name="item_<?php echo $rowcount; ?>[]"
                                                               value="text"
