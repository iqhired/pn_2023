...
<head>
    ...
    <title><?php echo $sitename; ?> | Analytics Trend Graph</title>
    <!-- Global stylesheets -->
...
<body>
<!-- Main navbar -->
<?php $cust_cam_page_header = "Analytics Trend Graph";
include("../header.php");
                ...
                <table class="table datatable-basic">
                    ...
                    while ($rowc = mysqli_fetch_array($qur)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="form_item_data_view.php?id=<?php echo $rowc['form_create_id']; ?>&station=<?php echo $rowc['station']; ?>&form_type=<?php echo $rowc['form_type']; ?>"
...
<script type="text/javascript">
    $(function () {
        $("#btn").bind("click", function () {
            var url = window.location.origin + "/form_module/form_graph.php?station=" + $("#station")[0].value;
            window.close();
