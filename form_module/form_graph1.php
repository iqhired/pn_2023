            ...
            <div class="panel panel-flat" >
                <table class="table datatable-basic">
                    ...
                    while ($rowc = mysqli_fetch_array($qur)) {
                        ...
                        $query1  = mysqli_query($db, "SELECT form_create_id FROM  form_user_data where form_create_id = '$form_create_id'");
                        $rowc1 = mysqli_fetch_array($query1);
                        $form_create_id = $rowc1['form_create_id'];
                        $query2  = mysqli_query($db, "SELECT optional FROM  form_item where form_create_id  = '$form_create_id'");
                        ...
                        <tr <?php echo $style; ?>>
                            ...
                            <td>
                                <a href="form_item_data_view1.php?id=<?php echo $rowc['form_create_id']; ?>&station=<?php echo $rowc['station']; ?>&form_type=<?php echo $rowc['form_type']; ?>"
                                   class="btn btn-primary" style="background-color:#1e73be;" target="_blank"><i class="fa fa-forward"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
