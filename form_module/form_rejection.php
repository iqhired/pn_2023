...
//														$entry = 'selected';
                        ...
                        <div class="card-body pt-0">
                            ...
                            <button type="clear" id="btn" class="btn btn-primary pd-x-30 mg-r-5 mg-t-5" onclick="location.reload();">Reset</button>
                            <form action="export_view_form.php" method="post" name="export_excel">
                                <input type="hidden" name="export">
                            <button type="submit"  id="export_btn" name="export_btn" class="btn btn-primary pd-x-30 mg-r-5 mg-t-5">Export</button>
                            </form>
                                       ...
                                       <?php
                                          if($r_flag != '1'){ ?>
                                            ...
                                            <td class="">
                                                ...
                                                <a class="btn btn-success btn-sm br-5 me-2" href="view_closed_form.php?id=<?php echo $rowc['form_user_data_id']; ?>&optional=<?php echo $option; ?>">
                                          ...
                                          <?php }else if($r_flag == '1'){ ?>
                                                ...
                                                <td>
                                                    <?php $finalid = $rowc['form_create_id']; ?>
                                                    <a class="btn btn-success btn-sm br-5 me-2" href="edit_rejection.php?id=<?php echo $rowc['form_user_data_id']; ?>&optional=<?php echo $option; ?>">
                                                        <i class="fa fa-file" style="padding: 1px;font-size: 16px;"></i>
                                                    </a>
