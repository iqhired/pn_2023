...
<div class="query_rows">																			<br/>
<div class="qry_section">
	<button type="button" name="add_more" id="add_more" class="btn btn-primary legitRipple" style="background-color:#1e73be;">Add Form Item</button>
	
	<div class="row">
    <div class="col-md-2"><label for="query_text">Item Description :</label></div>
    <div class="col-md-6"><input type="text" class="form-control" name="query_text" id="query_text" autocomplete="off"  placeholder="Item Description..." required></div>
  </div>
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="form-check form-check-inline">
			<input type="radio" id="numeric" name="item" value="numeric" class="form-check-input" checked="checked">
			<label for="numeric" class="item_label">Numeric</label>
			<input type="radio" id="binary" name="item" value="binary" class="form-check-input">
			<label for="binary" class="item_label">Binary</label>
			<input type="radio" id="text" name="item" value="text" class="form-check-input">
			<label for="text" class="item_label">Text</label>
			<input type="radio" id="header" name="item" value="header" class="form-check-input">
	...
	<div class="numeric_section">
		<div class="row">
			...
			<div class="col-md-6">
				<input class="form-control" name="normal" id="normal" autocomplete="off"> </div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-2">
			...
			<div class="col-md-6">
				<input class="form-control" name="lower_tolerance" id="lower_tolerance" autocomplete="off"> </div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-2">
			...
			<div class="col-md-6">
				<input class="form-control" name="upper_tolerance" id="upper_tolerance" autocomplete="off"> </div>
		</div>
		<br> </div>
	<div class="binary_section">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-check form-check-inline">
					<input type="radio" id="none" name="default_binary" value="none" class="form-check-input" checked="checked">
					<label for="none" class="item_label">None</label>
					<input type="radio" id="yes" name="default_binary" value="yes" class="form-check-input">
					<label for="yes" class="item_label">Yes</label>
					<input type="radio" id="no" name="default_binary" value="no" class="form-check-input">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-check form-check-inline">
					<input type="radio" id="yes" name="normal_binary" value="yes" class="form-check-input" checked="checked">
					<label for="yes" class="item_label">Yes</label>
					<input type="radio" id="no" name="normal_binary" value="no" class="form-check-input">
					<label for="no" class="item_label">No</label>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-6">
				<input type="text" class="form-control" name="yes_alias" id="yes_alias" autocomplete="off"> </div>
		</div>
		<div class="row">
			<div class="col-md-2">
			...
			<div class="col-md-6">
				<input type="text" class="form-control" name="no_alias" id="no_alias" autocomplete="off"> </div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-2">
...
<br/>																	
                                                                ...
                                                                ?>
																			...
																			<div class="row">
																				...
																				<div class="col-md-6">
																					<div class="form-group">
																						<select class="select-border-color select-access-multiple-open" data-placeholder="Notification List ..." name="users[]" id="users" multiple="multiple">
																							<?php
                                                                ...
                                                                ?>
																			...
																			<div class="row">
																				...
																				<div class="col-md-6">
																					<textarea id="notes" name="notes" rows="4" placeholder="Enter Notes..." class="form-control">
																						<?php echo $rowc["message"]; ?>
																					</textarea>
																				</div>
																			</div>
																			<br/>
                                                                ...
                                                                ?>
																			...
																			<div class="row">
																				<div class="col-md-2">
																					<button type="button" class="btn btn-primary" onclick="submitFormSettings('form_settings_backend.php')" style="background-color:#1e73be;">Submit</button>
																				</div>
																			</div>
																			<br/> </form>
																	</div>
			...
			<?php include ('../footer.php') ?>
				...
				window.onload = function() {
					history.replaceState("", "", "<?php echo $scriptName; ?>form_module/form_settings.php");
				}
				</script>
				<script>
