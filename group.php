...
<head>
    ...
    <title>
        <?php echo $sitename; ?> |Groups</title>
    <!-- Global stylesheets -->
...
<div class="main-content app-content">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <ol class="breadcrumb">
                <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">User Group</a></li>
                ...
                <div class="card">
                    <div class="">
                        <div class="card-header">
                            <span class="main-content-title mg-b-0 mg-b-lg-1">GROUP</span>
                        </div>
                                ...
                                <div class="col-sm-12">
                                    <table class="table datatable-basic table-bordered text-nowrap mb-0" id="example2">
                                        ...
                                        while ($rowc = mysqli_fetch_array($qur)) {
                                            ?>
                                            <tr>
                                                <td><label class="ckbox"><input type="checkbox" id="delete_check[]" name="delete_check[]" value="<?php echo $rowc["group_id"]; ?>"><span></span></label></td>
                                                <td><?php echo ++$counter; ?></td>
                                                <td>
                                                    <button type="button" id="edit" class="btn btn-primary btn-xs submit_btn" data-id="<?php echo $rowc['group_id']; ?>" data-name="<?php echo $rowc['group_name']; ?>" data-parent="<?php echo $rowc['parent_id']; ?>" data-disc="<?php echo $rowc['description']; ?>"  data-toggle="modal" style="background-color:#1e73be;" data-target="#edit_modal_theme_primary"><i class="fa fa-edit"></i> </button>
    ...
    <div class="modal-dialog" style="width:100%">
        <div class="modal-content">
            <div class="card-header">
                ...
                <span class="main-content-title mg-b-0 mg-b-lg-1">Update Group</span>
            </div>
