										...
										<div class="heading-elements">
											<ul class="icons-list">
												<li class="dropdown">
													...
													<ul class="dropdown-menu dropdown-menu-right" style="min-width: 210px !important;">
                                                        ...
                                                        <li>
                                                            <a href="form_module/form_search.php?station=<?php echo $rowc["line_id"]; ?>"
                                                               target="_BLANK"><i class="fa fa-eye"></i>View Form</a>
                                                        </li>
                                                        <li>
                                                            <a href="assignment_module/assign_crew.php?line=<?php echo $rowc["line_id"]; ?>"
                                                               target="_BLANK"><i class="icon-sync"></i>Assign / Unassign Crew</a>
                                                        </li>
                                                        <li>
