...
$sql_old = "select * from cam_assign_crew_log_update ORDER BY assign_crew_log_old_id DESC LIMIT 1";
$result_old = mysqli_query($db, $sql_old);
while ($row_old = mysqli_fetch_array($result_old)) {
	$assign_crew_log_old_id = $row_old['assign_crew_log_old_id'];
}

$sql0 = "select * from cam_assign_crew_log WHERE assign_crew_log_id > '$assign_crew_log_old_id'";
