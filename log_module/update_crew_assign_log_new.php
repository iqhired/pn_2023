...
$sql_st = "select assign_crew_log_old_id from cam_assign_crew_log_update ORDER BY assign_crew_log_update_id DESC LIMIT 1";
$result_st = mysqli_query($db,$sql_st);
$row_st =  mysqli_fetch_array($result_st);
$crew_assign_old_id = $row_st['assign_crew_log_old_id'];

$sql0 = "SELECT * FROM cam_assign_crew_log where assign_crew_log_id > '$crew_assign_old_id'";
