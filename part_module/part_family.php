...
<head>
    ...
    <title><?php echo $sitename; ?> | Part Family</title>
    <!-- Global stylesheets -->
...
<body>
<!-- Main navbar -->
<?php $cust_cam_page_header = "Add Part Family ";
include("../header.php");
...
<div class="page-container">
    <!-- Page content -->
            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <form action="" id="user_form" class="form-horizontal" method="post">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="name" id="name" class="form-control"
                                                   placeholder="Enter Part Family" required>
                                ...
                                <div class="col-md-6 mobile">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <select name="station" id="station" class="select" data-style="bg-slate" required >
                        ...
                        <div class="panel-footer p_footer">
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-primary" style="background-color:#1e73be;">
                                    Add
                                </button>
                            </div>
                        </div>
                ...
                <form action="delete_part_family.php" id="delete-form" method="post" class="form-horizontal">
                    <div class="row">
                        <div class="col-md-3">
                            <button type="button" onclick="submitFormdelete('delete_part_family.php')"  class="btn btn-primary" style="background-color:#1e73be;">Delete
                            </button>
                        </div>
						<div class="col-md-4">	
                        </div>
						<div class="col-md-2">
                            <select class="form-control" name="choose" id="choose" required>
                                ...
                                <option value="1">Add to Account</option>
                            </select>
                        </div>
						<div class="col-md-2 group_div" style="display:none">
                            <select class="select form-control" name="accnt"  id="accnt"  required>
						...
						<div class="col-md-1">
                            <button type="button" class="btn btn-primary" onclick="submitFormgo('part_family_option_backend.php')"  style="background-color:#1e73be;">Go</button>
                        </div>
                    </div>
                    <br/>
                    <div class="panel panel-flat">
							...
							while ($rowc = mysqli_fetch_array($qur)) {
                                ...
                                <tr>
                                    <td><input type="checkbox" id="delete_check[]" name="delete_check[]"
                                               value="<?php echo $rowc["pm_part_family_id"]; ?>"></td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            ...
                            <h6 class="modal-title">Update Part Family</h6>
                        </div>
                        <form action="" id="user_form" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <textarea id="edit_notes" name="edit_notes" rows="4"
                                                          placeholder="Enter Notes..." class="select form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
