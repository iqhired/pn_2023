...
//            if (isset($_FILES['image'])) {
            if (file_exists($_FILES['image']) || is_uploaded_file($_FILES['image'])) {
                $errors = array();
                ...
                if (empty($errors) == true) {
                    move_uploaded_file($file_tmp, "../assets/images/part_images/" . $name ."_". $file_name);
...
//		$sql0 = "INSERT INTO `pm_part_number`(`part_number` ,`part_name` , `customer_part_number`, `station` , `part_family` , `npr` , `through_put` , `budget_scrape_rate` , `net_weight` ,  `part_length`,`length_range`, `notes` ,`created_by`) VALUES ('$name','$part_name','$customer_part_number','$station','$part_family','$npr','$through_put','$budget_scrape_rate','$net_weight','$part_length','$length_range','$notes','$assign_by')";
	...
	if ($edit_name != "") {
		$id = $_POST['edit_id'];
		$sql = "update pm_part_number set part_number='$_POST[edit_name]',part_name='$_POST[edit_part_name]', customer_part_number='$_POST[edit_customer_part_number]', station='$_POST[edit_station]', part_family='$_POST[edit_part_family]', npr='$_POST[edit_npr]', through_put='$_POST[edit_through_put]',budget_scrape_rate='$_POST[edit_budget_scrape_rate]', net_weight='$_POST[edit_net_weight]', part_length='$_POST[edit_part_length]',length_range='$_POST[edit_length_range]', notes='$_POST[edit_notes]', created_by='$assign_by' where pm_part_number_id = '$id'";
		...
		if (file_exists($_FILES['edit_image']) || is_uploaded_file($_FILES['edit_image'])) {
            ...
            if($totalfiles > 0 && $_FILES['edit_image']['name'][0] !='' && $_FILES['edit_image']['name'][0] != null){
				...
				for($i=0;$i<$totalfiles;$i++){
					...
					if (empty($errors) == true) {
						move_uploaded_file($file_tmp, "../assets/images/part_images/" . $file_name);
//					$sql0 = "select part_images from pm_part_number where pm_part_number_id = '$id'";
						...
						if($pnum != null && $pnum != ''){
							$part_img = $pnum . ',' . $file_name;
							$sql0 = "update pm_part_number set part_images = '$part_img'   where pm_part_number_id = '$id'";
							$result11 = mysqli_query($db, $sql0);
						}else{
							$sql0 = "update pm_part_number set part_images = '$file_name'  where pm_part_number_id = '$id'";
							$result11 = mysqli_query($db, $sql0);
						}
...
<head>
    ...
    <!-- /global stylesheets -->
    <!-- Core JS files -->
    <script type="text/javascript" src="../assets/js/plugins/loaders/pace.min.js">
    </script>
    ...
    <script type="text/javascript" src="../assets/js/plugins/loaders/blockui.min.js">
    </script>
    <!-- /core JS files -->
    <!-- Theme JS files -->
    <script type="text/javascript" src="../assets/js/plugins/tables/datatables/datatables.min.js">
    </script>
    <script type="text/javascript" src="../assets/js/plugins/forms/selects/select2.min.js">
    </script>
    <script type="text/javascript" src="../assets/js/core/app.js">
    </script>
    <script type="text/javascript" src="../assets/js/pages/datatables_basic.js">
    </script>
    <script type="text/javascript" src="../assets/js/plugins/ui/ripple.min.js">
    </script>
    <script type="text/javascript" src="../assets/js/plugins/notifications/sweet_alert.min.js">
    </script>
    <script type="text/javascript" src="../assets/js/pages/components_modals.js">
    </script>
    <script type="text/javascript" src="../assets/js/plugins/ui/ripple.min.js">
    </script>
    <script type="text/javascript" src="../assets/js/plugins/forms/selects/bootstrap_select.min.js">
    </script>
    <script type="text/javascript" src="../assets/js/pages/form_bootstrap_select.js">
    </script>
    <script type="text/javascript" src="../assets/js/pages/form_layouts.js">
    </script>
...
<!-- Main navbar -->
<?php
$cam_page_header = "Add Part Number";
                ...
                <form action="" id="update-form" method="post" class="form-horizontal">
                    ...
                    <div class="panel panel-flat">
                        <table class="table datatable-basic">
                            ...
                            <tbody>
							<?php
							$query = sprintf("SELECT * FROM  pm_part_number ;  ");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" id="edit" class="btn btn-info btn-xs"
                                                ...
                                                data-part_images="<?php echo $rowc['part_images']; ?>"
                                                data-pm_image="<?php echo $rowc['part_images']; ?>"
                        ...
                        <form action="" id="user_form" enctype="multipart/form-data" class="form-horizontal"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">Customer Part Number :</label>
                                            <div class="col-lg-8">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <input type="file" name="edit_image[]" id="edit_image" class="form-control" multiple>
