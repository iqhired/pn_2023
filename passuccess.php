            ...
            <div class="panel-heading">
                ...
                <form action=""  method="post" >
                    <div id="col-md-6 mobile" >
                        <br/>
                        <label style="color: darkgreen;"><b>Your password has been change successfully..</b></label><br>

                    </div>
                    <div id="col-md-6 mobile" >
                        <br/>
                        <label>Click here Re-login the page: </label>

                    </div>
                    <br/><br/>
                    <button name="submit"><a href="<?php $siteURL ?>">Link</a>
