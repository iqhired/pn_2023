...
<head>
    ...
    <title>
        <?php echo $sitename; ?> |Communicator Config</title>
    <!-- Global stylesheets -->
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Communicator Config</li>
            </ol>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="">
                        ...
                        <div class="card-header">
                            <span class="main-content-title mg-b-0 mg-b-lg-1">Communicator Config</span>
                        </div>
                        <?php
