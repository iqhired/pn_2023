...
if (count($_POST) > 0) {
    ...
    $sql = "update sg_email_report_config set teams='$array_team',users='$array_user',subject='$_POST[subject]',message='$_POST[message]',signature='$_POST[signature]' where sg_mail_report_config_id='2'";
...
<html lang="en">
    <head>
        ...
        <title><?php echo $sitename; ?> | Communicator Config</title>
        <!-- Global stylesheets -->
                    ...
                    <div class="content">
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title">Communicator Config</h5>
                                <?php if ($temp == "one") { ?>
                                        ...
                                        <div class="col-md-12">
                                            <form action="" id="user_form" enctype="multipart/form-data"  class="form-horizontal" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <select class="select-border-color select-access-multiple-open" data-placeholder="Add Users ..." name="users[]" id="users"  multiple="multiple" >
                                                                <?php
...
<script>
    window.onload = function() {
        history.replaceState("", "", "<?php echo $scriptName; ?>report_config_module/communicator_config.php");
    }
</script>
        <script>
