...
<head>
    ...
    <title>
        <?php echo $sitename; ?> | Daily Efficiency Report Log </title>
    <!-- Global stylesheets -->
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Daily Efficiency Report Log</li>
                </ol>
            </div>
        </div>
        <!-- /breadcrumb -->
                    ...
                    <div class="col-lg-10 col-xl-10 col-md-12 col-sm-12">
                        <div class="card  box-shadow-0">
                            <div class="card-header">
                                <span class="main-content-title mg-b-0 mg-b-lg-1">Daily Efficiency Report Log</span>
                            </div>
