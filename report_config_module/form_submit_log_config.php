...
<head>
    ...
    <title>
        <?php echo $sitename; ?> | First Piece Sheet Log Config</title>
    <!-- Global stylesheets -->
...
<div class="main-content app-content">
    ...
    <div class="main-container container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">First Piece Sheet Log Config</li>
                </ol>
            </div>
        </div>
        <!-- /breadcrumb -->
        ...
        <?php
        $query = sprintf("SELECT * FROM  sg_email_report_config where sg_mail_report_config_id = '3'");
                    ...
                    <div class="col-lg-10 col-xl-10 col-md-12 col-sm-12">
                        <div class="card  box-shadow-0">
                            <div class="card-header">
                                <span class="main-content-title mg-b-0 mg-b-lg-1">First Piece Sheet Log Config</span>
                            </div>
