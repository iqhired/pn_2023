...
<head>
    ...
    <title><?php echo $sitename; ?> |Scan Line Asset</title>
    <!-- Global stylesheets -->
...
<!-- Main navbar -->
<?php
$cust_cam_page_header = "Scan Station Asset";
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Scan Station Asset</h5><br/>
                <div class="row">
                    <div class="col-md-12">
...
<script>
    window.onload = function () {
        history.replaceState("", "", "<?php echo $scriptName; ?>report_config_module/scan_line_asset.php");
    }
</script>
