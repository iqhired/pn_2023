...
<html lang="en">
    <head>
        ...
        <title><?php echo $sitename; ?> | Task Log Config</title>
        <!-- Global stylesheets -->
                    ...
                    <div class="content">
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title">Task Log Config</h5>
                                <?php
                                ...
                                <ul class="nav nav-tabs nav-tabs-highlight">
                                    ...
                                    while ($rowc = mysqli_fetch_array($qur)) {
                                        ...
                                        ?>
                                        <li <?php echo $class; ?>><a href="#css-animate-tab<?php echo $i; ?>" data-toggle="tab"><?php echo $taskboard_name; ?></a></li>
                                        <?php
                                        $i++;
                                    }
                                    ?>
