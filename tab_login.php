...
$_SESSION['tab_station'] = $_REQUEST['s_id'];
$_SESSION['is_tab_user'] = (isset($_REQUEST['s_id']) && ($_REQUEST['s_id'] != ''))?1:0;
$_SESSION['cell_id'] = $_REQUEST['c_id'];
$_SESSION['is_cell_login'] = (isset($_REQUEST['c_id']) && ($_REQUEST['c_id'] != ''))?1:0;
if (count($_POST) > 0){
    $user = $_POST["user"];
    ...
    if ($pin_flag == "1") {
        if ($pin == "0") {
            ...
            if($_SESSION['is_cell_login']){
                header("Location:cell_line_dashboard.php");
            }else{
                header("Location:line_tab_dashboard.php");
            }
