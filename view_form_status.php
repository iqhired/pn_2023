...
while ($resultado = mysqli_fetch_array($qurtemp)) {
    ...
    $name = 'Forms Will Not Be Submitted During';
            ...
            <div class="content_noheader">
                <div class="row h-80">
                    ...
                    <div class="col-lg-8 cell2" style="background-color: #fff; padding: 0px;">
                        <div class="event-status-heading ver_align" style="background-color:<?php echo $status_color; ?>;"><?php echo $name.$e_name ?></div>
            ...
            <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="content-wrapper" style="background-color: #FFFFFF;">
                        ...
                        <div class="content_noheader" >
                            <div class="row h-100">
                                <div class="event-status-heading-end ver_align" style="background-color:<?php echo $status_color; ?>;"><?php echo $name.' '.$e_name ?></div>
                                <input type="hidden" id="id<?php echo $countervariable; ?>" value="<?php echo $time; ?>">
                                <div class="event-timer ver_align">
                                    <h4 style="text-align: center;">
                                        <div class="event-timer-val" id="demo<?php echo $countervariable; ?>">&nbsp;</div>
